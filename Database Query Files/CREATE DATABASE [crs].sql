...
/****** Object:  Database [crs]    Script Date: 2020-01-08 8:07:02 PM ******/
CREATE DATABASE [crs]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'crs', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\crs.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'crs_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\crs_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
...
ALTER DATABASE [crs] SET AUTO_CLOSE OFF 
GO
...
ALTER DATABASE [crs] SET  DISABLE_BROKER 
GO
